...
# vcasellesb: NO PROBLEM... I actually did barely anything... Thanks to you guys for the code here in this file :)
# Taken from: https://github.com/MIC-DKFZ/batchgeneratorsv2.git
